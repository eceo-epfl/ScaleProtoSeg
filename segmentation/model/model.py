"""
Pytorch Module for training prototype segmentation model from https://github.com/gmum/proto-segmentation.
...
from segmentation.model.deeplab_features import (
    deeplabv2_resnet50_features,
    deeplabv2_resnet101_features,
    deeplabv2_vgg16_features,
    unet_aspp_features,
    unet_features,
)
...
base_architecture_to_features = {
    ...
    "deeplabv2_vgg16": deeplabv2_vgg16_features,
    "deeplabv2_resnet50": deeplabv2_resnet50_features,
    "unet": unet_features,
...
class PPNet(nn.Module):
    def __init__(
        ...
        if features_name.startswith("VGG") or features_name.startswith("RES"):
            ...
            # For VGG & UNet no PB but not exactly what needed
