"""
Pytorch Lightning Module for training prototype segmentation model on EM.

Slight modifications compare to module.py
"""
import os
...
class PatchClassificationModule(LightningModule):
    ...
    def configure_optimizers(self):
        ...
        def print_optimizer_params(model, optimizer):
        ...
        print_optimizer_params(self.ppnet, optimizer)
